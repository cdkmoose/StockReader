...
{
    partial class TimerIntervalForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.panel1.Size = new System.Drawing.Size(257, 148);
			...
			this.panel2.Controls.Add(this.updInterval);
			...
			// updInterval
			// 
			this.updInterval.Location = new System.Drawing.Point(117, 29);
			this.updInterval.Maximum = new decimal(new int[] {
            60,
            0,
            0,
            0});
			this.updInterval.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
			this.updInterval.Name = "updInterval";
			this.updInterval.Size = new System.Drawing.Size(38, 20);
